...
import tx3 from '../img/tx3.webp'
import tx4 from '../img/tx4.webp'
    ...
    <div className="danmu-list">
      <ul>
        ...
        <li>
          ...
          <span className="danmu-span-right">啦啦啦啦姐姐我来了～～</span>
        </li>
        ...
        <li>
          <div className="danmu-div-left">
            <Avatar style={{ backgroundColor: '#51678b' }} icon={<UserOutlined />} />
            <span>&nbsp;&nbsp;游客0521：</span>
          </div>
          <span className="danmu-span-right">啦啦啦啦姐姐我来了～～</span>
        </li>
